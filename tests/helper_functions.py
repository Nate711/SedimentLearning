...
def get_AOI(img_path, (img_lat0, img_long0), (img_lat1, img_long1), (aoi_lat0, aoi_long0),
            (aoi_lat1, aoi_long1)=(None, None), radius=None):
    ...
    # return the specified area in the image
        ...
        # interpolate the image coordinates
        img_aoi_left, img_aoi_right = np.int32(
            np.interp([aoi_long0, aoi_long1], [img_long0, img_long1], [0, img_width]))
...
if __name__ == '__main__':
    ...
    img = get_AOI('/Users/Nathan/Desktop/Turbidity/SedimentLearning/tests/LC80440342013298LGN00_sr_evi.tif',
                  (38.529033, -123.415482), (36.397332, -120.779472), (37.811068, -122.477161), radius=100)
